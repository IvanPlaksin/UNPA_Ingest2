#!/usr/bin/env node
/**
 * Seeds Priority 6-7-8 KG updates into Memgraph.
 * Usage: node api/scripts/seed-priority8.js
 */
...
async function main() {
  ...
  const cypherFile = path.join(__dirname, 'kg-seed-priority8.cypher');
  ...
  console.log(`[KG-Seed-P8] Executing ${statements.length} statements...\n`);
  ...
  console.log(`\n[KG-Seed-P8] Done: ${ok} succeeded, ${fail} failed out of ${statements.length}`);
