...
const { extractServiceCatalog } = require('./service-catalog.extractor');
const { extractSLARules } = require('./sla-rules.extractor');
const { extractClassificationRules } = require('./classification-rules.extractor');
const { extractRoutingRules } = require('./routing-rules.extractor');
const { extractDialogGraphs } = require('./dialog-graph.extractor');
...
async function runFlowDeskExtraction(workspaceId, sourceId, options = {}) {
  ...
  let draftService;
  try {
    draftService = require('../../draft.service');
  } catch (err) {
...
const catalogIntegration = require('./catalog-integration');
...
module.exports = {
  ...
  // GXE Builder
  GxeGraphBuilder: require('./gxe-builder').GxeGraphBuilder
};
