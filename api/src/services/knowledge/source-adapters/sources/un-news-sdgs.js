'use strict';
/**
 * Per-source adapter — UN News — SDGs (un-news-sdgs).
 * Family: rss-feed. Auto-generated from research/un-news-sdgs.json by
...
class UnNewsSdgsAdapter extends RssFeedAdapter {
  static key          = "un-news-sdgs";
