'use strict';
/**
 * Per-source adapter — UN News — Economic Development (un-news-econ).
 * Family: rss-feed. Auto-generated from research/un-news-econ.json by
...
class UnNewsEconAdapter extends RssFeedAdapter {
  static key          = "un-news-econ";
