...
const { MSSQL_CONFIG, MEMGRAPH_CONFIG, IMPORT_CONFIG } = require('./import-config.js');
const { NODE_LABELS, REL_TYPES, LOCATION_TYPES, INDEX_STATEMENTS } = require('./graph-schema.js');
