...
function convertGxeToAopegDag(nodes, edges) {
  ...
  const LABEL_TO_EXECUTOR = {
    ...
    'laptop q&a assistant': 'flowdesk.laptop_assistant',
    'laptop assistant': 'flowdesk.laptop_assistant',
    'laptop provisioning assistant': 'flowdesk.laptop_assistant',
...
async function processMessage(sessionId, userId, message, graphVersion = null, graphId = null) {
  ...
  try {
    const bridge = require('./gxe-manager-bridge.js');
